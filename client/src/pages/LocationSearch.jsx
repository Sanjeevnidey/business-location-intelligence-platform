    ...
    <div>
      <div className="page-heading">
        <div>
          ...
          <h1>Find a business opportunity</h1>
          <p>Choose what you want to evaluate and where.</p>
        </div>
      </div>
      <div className="search-layout">
        <form className="panel search-form" onSubmit={submit}>
          ...
          <p className="muted">
            We'll retrieve nearby geographic data and calculate a transparent
            score.
          </p>
          <label>
            Business type
        ...
        <div className="panel checklist">
          ...
          {[
            ...
            <div className="check" key={x}>
              ...
              <div>
                <b>{x}</b>
                <p>Included in your location report.</p>
              </div>
            </div>
          ))}
        </div>
